...
var htmlHandler = new(function() {
	...
	function checkIfCreateAJECanBeAllowed(){
		//permet al modification de création je si on quitte la page avant la fin || si première je
		console.log(v_currentlyDisplayed);
		if(v_currentlyDisplayed==="jeCreation" || v_currentlyDisplayed==="jeCreationIfNoJE"){
	...
	return{
		...
		checkIfCreateAJECanBeAllowed:checkIfCreateAJECanBeAllowed
	}
});