...
public interface ContactUCC {
   ...
   */
  List<ContactDTO> fillInfosContacts(CompanyDTO companyDTO, JEDTO jeCurrent);
  ...
  /**
   * Update the participation of a contact for the current JE.
   * 
   * @param contactDTO a DTO (Data Transfer Object) for all the informations to update the
   *        participation of the contact,
   * @param jeCurrent a DTO (Data Transfer Object) for the id of the current je.
   */
  void updateParticipation(ContactDTO contactDTO, JEDTO jeCurrent);
