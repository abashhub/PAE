...
public class ContactImpl implements Contact {
  ...
  public void checkContact() {
    if (this.company == null) {
      throw new BizzException("Entreprise inexistante.");
    }
    ...
    if ((this.email == null || this.email.isEmpty())
        && (this.telephone == null || this.telephone.isEmpty())) {
      throw new BizzException("Entrez un email et/ou un numéro de téléphone.");
    }
    if (this.email != null && !this.email.equals("") && !Util.isValidEmail(this.email)) {
      throw new BizzException("L'email est invalide.");
    }
  }

  @Override
  public void checkContactForUpdate() {
    if (Util.anyNull(this.lastName, this.firstName)) {
      throw new BizzException("Un ou plusieurs champs sont incomplets.");
    }
    if (Util.anyEmptyString(this.lastName, this.firstName)) {
      throw new BizzException("Un ou plusieurs champs sont incomplets.");
